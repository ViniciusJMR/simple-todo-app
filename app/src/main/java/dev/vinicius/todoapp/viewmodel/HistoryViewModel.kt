...
import dev.vinicius.todoapp.domain.todousecase.GetAllFinishedTodoUseCase
...
class HistoryViewModel @Inject constructor(
    app: Application,
    private val getAllFinishedTodoUseCase: GetAllFinishedTodoUseCase,
    ...
    private val updateTodoItemDoneUseCase: UpdateTodoItemDoneUseCase
        ...
        fun getAllNotFinished() {
            viewModelScope.launch {
                getAllFinishedTodoUseCase()
                    .onStart {
